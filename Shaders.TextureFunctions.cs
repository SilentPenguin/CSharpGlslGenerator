...
public abstract partial class RenderShader
{
    ...
    protected extern int textureSize(isampler1D sampler, int lod);
    ...
    protected extern ivec2 textureSize(sampler2DRectShadow sampler);
    ...
    protected extern ivec2 textureSize(sampler2DMS sampler);
    protected extern ivec2 textureSize(isampler2DMS sampler);
    protected extern ivec2 textureSize(usampler2DMS sampler);
    protected extern ivec2 textureSize(sampler2DMSArray sampler);
    protected extern ivec2 textureSize(isampler2DMSArray sampler);
    ...
    protected extern ivec4 texture(isampler1D sampler, float p, float bias = 0);
    ...
    protected extern uivec4 texture(usampler2D sampler, vec2 p, float bias = 0);
    ...
    protected extern uivec4 texture(usampler3D sampler, vec3 p, float bias = 0);
    ...
    protected extern float texture(sampler2DRectShadow sampler, vec2 p);
    
    protected extern vec4 textureProj(sampler1D sampler, vec2 p, float bias = 0);
    protected extern ivec4 textureProj(isampler1D sampler, vec2 p, float bias = 0);
    protected extern uivec4 textureProj(usampler1D sampler, vec2 p, float bias = 0);
    protected extern vec4 textureProj(sampler1D sampler, vec4 p, float bias = 0);
    protected extern ivec4 textureProj(isampler1D sampler, vec4 p, float bias = 0);
    protected extern uivec4 textureProj(usampler1D sampler, vec4 p, float bias = 0);
    protected extern vec4 textureProj(sampler2D sampler, vec3 p, float bias = 0);
    protected extern ivec4 textureProj(isampler2D sampler, vec3 p, float bias = 0);
    protected extern uivec4 textureProj(usampler2D sampler, vec3 p, float bias = 0);
    ...
    protected extern vec4 textureProj(sampler2DRect sampler, vec3 p);
    protected extern ivec4 textureProj(isampler2DRect sampler, vec3 p);
    protected extern uivec4 textureProj(usampler2DRect sampler, vec3 p);
    ...
    protected extern float textureProj(sampler2DRectShadow sampler, vec2 p);

    protected extern vec4 textureLod(sampler1D sampler, float p, float lod);
    protected extern ivec4 textureLod(isampler1D sampler, float p, float lod);
    ...
    protected extern uivec4 textureLod(usampler3D sampler, vec3 p, float lod);
    ...
    protected extern vec4 textureOffset(sampler1D sampler, float p, int offset, float bias = 0);
    protected extern ivec4 textureOffset(isampler1D sampler, float p, int offset, float bias = 0);
    protected extern uivec4 textureOffset(usampler1D sampler, float p, int offset, float bias = 0);
    protected extern vec4 textureOffset(sampler2D sampler, vec2 p, ivec2 offset, float bias = 0);
    protected extern ivec4 texttextureOffsetureLod(isampler2D sampler, vec2 p, ivec2 offset, float bias = 0);
    protected extern uivec4 textureOffset(usampler2D sampler, vec2 p, ivec2 offset, float bias = 0);
    protected extern vec4 textureOffset(sampler3D sampler, vec3 p, ivec3 offset, float bias = 0);
    protected extern ivec4 textureOffset(isampler3D sampler, vec3 p, ivec3 offset, float bias = 0);
    protected extern uivec4 textureOffset(usampler3D sampler, vec3 p, ivec3 offset, float bias = 0);
    ...
    protected extern float textureOffset(sampler1DShadow sampler, vec3 p, int offset, float bias = 0);
    protected extern float textureOffset(sampler2DShadow sampler, vec3 p, ivec2 offset, float bias = 0);
    ...
    protected extern ivec4 texelFetch(isampler1D sampler, int p, int lod);
    protected extern uivec4 texelFetch(usampler1D sampler, int p, int lod);
    protected extern vec4 texelFetch(sampler2D sampler, ivec2 p, int lod);
    ...
    protected extern vec4 texelFetch(sampler2DMS sampler, ivec2 p, int lod);
    protected extern ivec4 texelFetch(isampler2DMS sampler, ivec2 p, int lod);
    protected extern uivec4 texelFetch(usampler2DMS sampler, ivec2 p, int lod);
    protected extern vec4 texelFetch(sampler2DMSArray sampler, ivec3 p, int lod);
    protected extern ivec4 texelFetch(isampler2DMSArray sampler, ivec3 p, int lod);
    ...
    protected extern ivec4 texelFetchOffset(isampler1D sampler, int p, int lod, int offset);
    protected extern uivec4 texelFetchOffset(usampler1D sampler, int p, int lod, int offset);
    protected extern vec4 texelFetchOffset(sampler2D sampler, ivec2 p, int lod, ivec2 offset);
    ...
    protected extern vec4 textureProjOffset(sampler1D sampler, vec2 p, int offset, float bias = 0);
    protected extern ivec4 textureProjOffset(isampler1D sampler, vec2 p, int offset, float bias = 0);
    protected extern uivec4 textureProjOffset(usampler1D sampler, vec2 p, int offset, float bias = 0);
    protected extern vec4 textureProjOffset(sampler1D sampler, vec4 p, int offset, float bias = 0);
    protected extern ivec4 textureProjOffset(isampler1D sampler, vec4 p, int offset, float bias = 0);
    protected extern uivec4 textureProjOffset(usampler1D sampler, vec4 p, int offset, float bias = 0);
    protected extern vec4 textureProjOffset(sampler2D sampler, vec3 p, ivec2 offset, float bias = 0);
    protected extern ivec4 textureProjOffset(isampler2D sampler, vec3 p, ivec2 offset, float bias = 0);
    protected extern uivec4 textureProjOffset(usampler2D sampler, vec3 p, ivec2 offset, float bias = 0);
    ...
    protected extern vec4 textureProjOffset(sampler2DRect sampler, vec3 p, ivec2 offset, float bias = 0);
    protected extern ivec4 textureProjOffset(isampler2DRect sampler, vec3 p, ivec2 offset, float bias = 0);
    protected extern uivec4 textureProjOffset(usampler2DRect sampler, vec3 p, ivec2 offset, float bias = 0);
    ...
    protected extern ivec4 textureLodOffset(isampler1D sampler, float p, int lod, int offset);
    ...
    protected extern vec4 textureProjLod(sampler1D sampler, vec2 p, float lod);
    protected extern ivec4 textureProjLod(isampler1D sampler, vec2 p, float lod);
    protected extern uivec4 textureProjLod(usampler1D sampler, vec2 p, float lod);
    protected extern vec4 textureProjLod(sampler1D sampler, vec4 p, float lod);
    protected extern ivec4 textureProjLod(isampler1D sampler, vec4 p, float lod);
    protected extern uivec4 textureProjLod(usampler1D sampler, vec4 p, float lod);
    protected extern vec4 textureProjLod(sampler2D sampler, vec3 p, float lod);
    protected extern ivec4 textureProjLod(isampler2D sampler, vec3 p, float lod);
    ...
    protected extern uivec4 textureProjLod(usampler2D sampler, vec4 p, float lod);
    ...
    protected extern vec4 textureProjLodOffset(sampler1D sampler, vec2 p, float lod, int offset);
    protected extern ivec4 textureProjLodOffset(isampler1D sampler, vec2 p, float lod, int offset);
    protected extern uivec4 textureProjLodOffset(usampler1D sampler, vec2 p, float lod, int offset);
    protected extern vec4 textureProjLodOffset(sampler1D sampler, vec4 p, float lod, int offset);
    protected extern ivec4 textureProjLodOffset(isampler1D sampler, vec4 p, float lod, int offset);
    protected extern uivec4 textureProjLodOffset(usampler1D sampler, vec4 p, float lod, int offset);
    protected extern vec4 textureProjLodOffset(sampler2D sampler, vec3 p, float lod, ivec2 offset);
    protected extern ivec4 textureProjLodOffset(isampler2D sampler, vec3 p, float lod, ivec2 offset);
    protected extern uivec4 textureProjLodOffset(usampler2D sampler, vec3 p, float lod, ivec2 offset);
    ...
    protected extern ivec4 textureGrad(isampler1D sampler, float p, float dPdx, float dPdy);
    protected extern uivec4 textureGrad(usampler1D sampler, float p, float dPdx, float dPdy);
    protected extern vec4 textureGrad(sampler2D sampler, vec2 p, vec2 dPdx, vec2 dPdy);
    protected extern ivec4 textureGrad(isampler2D sampler, vec2 p, vec2 dPdx, vec2 dPdy);
    protected extern uivec4 textureGrad(usampler2D sampler, vec2 p, vec2 dPdx, vec2 dPdy);
    protected extern vec4 textureGrad(sampler3D sampler, vec3 p, vec3 dPdx, vec3 dPdy);
    protected extern ivec4 textureGrad(isampler3D sampler, vec3 p, vec3 dPdx, vec3 dPdy);
    protected extern uivec4 textureGrad(usampler3D sampler, vec3 p, vec3 dPdx, vec3 dPdy);
    ...
    protected extern vec4 textureGrad(sampler2DRect sampler, vec2 p, vec2 dPdx, vec2 dPdy);
    protected extern ivec4 textureGrad(isampler2DRect sampler, vec2 p, vec2 dPdx, vec2 dPdy);
    protected extern uivec4 textureGrad(usampler2DRect sampler, vec2 p, vec2 dPdx, vec2 dPdy);
    protected extern float textureGrad(sampler2DRectShadow sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    protected extern float textureGrad(sampler1DShadow sampler, vec3 p, float dPdx, float dPdy);
    protected extern float textureGrad(sampler2DShadow sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    ...
    protected extern vec4 textureGradOffset(sampler1D sampler, float p, float dPdx, float dPdy, int offset);
    protected extern ivec4 textureGradOffset(isampler1D sampler, float p, float dPdx, float dPdy, int offset);
    protected extern uivec4 textureGradOffset(usampler1D sampler, float p, float dPdx, float dPdy, int offset);
    protected extern vec4 textureGradOffset(sampler2D sampler, vec2 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern ivec4 textureGradOffset(isampler2D sampler, vec2 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern uivec4 textureGradOffset(usampler2D sampler, vec2 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern vec4 textureGradOffset(sampler3D sampler, vec3 p, vec3 dPdx, vec3 dPdy, ivec3 offset);
    protected extern ivec4 textureGradOffset(isampler3D sampler, vec3 p, vec3 dPdx, vec3 dPdy, ivec3 offset);
    protected extern uivec4 textureGradOffset(usampler3D sampler, vec3 p, vec3 dPdx, vec3 dPdy, ivec3 offset);
    protected extern vec4 textureGradOffset(sampler2DRect sampler, vec2 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern ivec4 textureGradOffset(isampler2DRect sampler, vec2 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern uivec4 textureGradOffset(usampler2DRect sampler, vec2 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern float textureGradOffset(sampler2DRectShadow sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern float textureGradOffset(sampler1DShadow sampler, vec3 p, float dPdx, float dPdy, int offset);
    protected extern float textureGradOffset(sampler2DShadow sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    ...
    protected extern vec4 textureProGrad(sampler1D sampler, vec2 p, float dPdx, float dPdy);
    protected extern ivec4 textureProGrad(isampler1D sampler, vec2 p, float dPdx, float dPdy);
    protected extern uivec4 textureProGrad(usampler1D sampler, vec2 p, float dPdx, float dPdy);
    protected extern vec4 textureProGrad(sampler1D sampler, vec4 p, float dPdx, float dPdy);
    protected extern ivec4 textureProGrad(isampler1D sampler, vec4 p, float dPdx, float dPdy);
    protected extern uivec4 textureProGrad(usampler1D sampler, vec4 p, float dPdx, float dPdy);
    protected extern vec4 textureProGrad(sampler2D sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    protected extern ivec4 textureProGrad(isampler2D sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    protected extern uivec4 textureProGrad(usampler2D sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    ...
    protected extern vec4 textureProGrad(sampler2DRect sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    protected extern ivec4 textureProGrad(isampler2DRect sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    protected extern uivec4 textureProGrad(usampler2DRect sampler, vec3 p, vec2 dPdx, vec2 dPdy);
    ...
    protected extern float textureProGrad(sampler2DRectShadow sampler, vec4 p, vec2 dPdx, vec2 dPdy);
    ...
    protected extern vec4 textureProjGradOffset(sampler1D sampler, vec2 p, float dPdx, float dPdy, int offset);
    protected extern ivec4 textureProjGradOffset(isampler1D sampler, vec2 p, float dPdx, float dPdy, int offset);
    protected extern uivec4 textureProjGradOffset(usampler1D sampler, vec2 p, float dPdx, float dPdy, int offset);
    protected extern vec4 textureProjGradOffset(sampler1D sampler, vec4 p, float dPdx, float dPdy, int offset);
    protected extern ivec4 textureProjGradOffset(isampler1D sampler, vec4 p, float dPdx, float dPdy, int offset);
    protected extern uivec4 textureProjGradOffset(usampler1D sampler, vec4 p, float dPdx, float dPdy, int offset);
    protected extern vec4 textureProjGradOffset(sampler2D sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern ivec4 textureProjGradOffset(isampler2D sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern uivec4 textureProjGradOffset(usampler2D sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    ...
    protected extern vec4 textureProjGradOffset(sampler2DRect sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern ivec4 textureProjGradOffset(isampler2DRect sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    protected extern uivec4 textureProjGradOffset(usampler2DRect sampler, vec3 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
    ...
    protected extern float textureProjGradOffset(sampler2DRectShadow sampler, vec4 p, vec2 dPdx, vec2 dPdy, ivec2 offset);
